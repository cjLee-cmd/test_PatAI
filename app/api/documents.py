...
async def upload_document(
    ...
    try:
        ...
        # For now, we'll process immediately but catch errors gracefully
        # try:
        #     chunk_count = document_processor.process_document(document, file_path)
        #     document.processed = True
        #     document.chunk_count = chunk_count
        #     db.commit()
        # except Exception as processing_error:
        #     print(f"Processing error for document {document.id}: {processing_error}")
...
async def add_sample_data(
    ...
    try:
        ...
        for i, sample in enumerate(sample_documents):
            ...
            embedding = document_processor.embedding_model.encode([sample['content']]).tolist()
